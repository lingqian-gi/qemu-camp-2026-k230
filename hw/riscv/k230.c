...
static void k230_soc_realize(DeviceState *dev, Error **errp)
{
    ...
    /* SPI / QSPI */
    static const int spi_irq[3] = {
        K230_SPI0_IRQ, K230_SPI1_IRQ, K230_SPI2_IRQ
    };
    static const int spi_dev[3] = {
        K230_DEV_QSPI0, K230_DEV_QSPI1, K230_DEV_SPI
    };
